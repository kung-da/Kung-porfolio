...
const DOMAINS = [
  {
    ...
    skills: [
      { name: "Python", lvl: 90, notes: "Primary language for data ingestion, transformation, automation, and pipeline utilities.", related: ["pandas", "pytest"] },
      { name: "SQL", lvl: 85, notes: "Used for analytics-ready datasets, data exploration, and BI semantic modeling.", related: ["Athena SQL", "PostgreSQL"] },
      { name: "PySpark", lvl: 82, notes: "Built batch transformations for lakehouse layers and large structured datasets.", related: ["Spark SQL", "DataFrames"] },
      { name: "ETL / ELT", lvl: 85, notes: "Designed end-to-end flows from raw API data to curated analytical tables.", related: ["Batch Pipeline", "Data Cleaning"] },
      { name: "Data Modeling", lvl: 78, notes: "Created fact and dimension style datasets for Power BI analysis.", related: ["Star Schema", "Gold Layer"] },
      { name: "Data Quality", lvl: 80, notes: "Applied validation checks, schema consistency, and reliable pipeline outputs.", related: ["Testing", "Validation"] },
    ],
  },
  {
    id: "ai", label: "PIPELINE & ORCHESTRATION", icon: Brain,
    skills: [
      { name: "Apache Airflow", lvl: 82, notes: "Orchestrated lakehouse workflows with DAG-based batch processing.", related: ["DAGs", "Scheduling"] },
      { name: "Incremental Processing", lvl: 78, notes: "Used checkpointing and date-based processing to avoid unnecessary re-runs.", related: ["Checkpointing", "Idempotency"] },
      { name: "API Ingestion", lvl: 84, notes: "Collected esports data from Riot APIs with structured ingestion logic.", related: ["REST API", "JSON"] },
      { name: "Async Crawling", lvl: 76, notes: "Implemented asynchronous collection patterns for faster API data fetching.", related: ["aiohttp", "Rate Limiting"] },
      { name: "Retry / Backoff", lvl: 74, notes: "Handled unstable API calls with retry logic and safer request control.", related: ["Error Handling", "Resilience"] },
    ],
  },
  {
    id: "backend", label: "CLOUD & LAKEHOUSE", icon: ServerCog,
    skills: [
      { name: "AWS S3", lvl: 80, notes: "Used S3-style object storage for raw and curated lakehouse data layers.", related: ["Object Storage", "Data Lake"] },
      { name: "AWS Athena", lvl: 76, notes: "Queried curated datasets directly from lakehouse storage for analytics.", related: ["SQL", "External Tables"] },
      { name: "Parquet", lvl: 82, notes: "Stored analytical datasets in efficient columnar format.", related: ["Columnar Storage", "Compression"] },
      { name: "Medallion Architecture", lvl: 84, notes: "Organized data into Bronze, Silver, Gold, and Platinum layers.", related: ["Bronze", "Silver", "Gold"] },
      { name: "Docker", lvl: 82, notes: "Containerized local development environment for reproducible pipeline execution.", related: ["Docker Compose", "Dev Environment"] },
    ],
  },
  {
    id: "cloud", label: "ANALYTICS & BI", icon: Cloud,
    skills: [
      { name: "Power BI", lvl: 84, notes: "Built dashboards from curated datasets to analyze esports performance metrics.", related: ["DAX", "Reports"] },
      { name: "Semantic Model", lvl: 76, notes: "Structured tables and relationships for cleaner dashboard development.", related: ["Measures", "Relationships"] },
      { name: "Dashboard Design", lvl: 80, notes: "Designed analytical pages focused on overview, champion, match, and player insights.", related: ["UX", "Storytelling"] },
      { name: "Fact / Dimension Tables", lvl: 78, notes: "Prepared analytics-friendly tables for reporting and exploration.", related: ["Star Schema", "Data Mart"] },
      { name: "Data Visualization", lvl: 82, notes: "Presented trends, rankings, distributions, and comparisons through BI visuals.", related: ["Charts", "KPIs"] },
    ],
  },
  {
    id: "frontend", label: "FRONTEND CRAFT", icon: Code2,
    skills: [
      { name: "React", lvl: 82, notes: "Built portfolio interfaces and reusable UI sections.", related: ["Components", "Hooks"] },
      { name: "TypeScript", lvl: 78, notes: "Used typed React components for safer frontend development.", related: ["Props", "Types"] },
      { name: "Framer Motion", lvl: 76, notes: "Created smooth motion effects and interactive UI transitions.", related: ["Animation", "Micro-interactions"] },
      { name: "TailwindCSS", lvl: 82, notes: "Styled responsive dark-mode interfaces with utility-first classes.", related: ["Responsive UI", "Design System"] },
    ],
  },
  {
    id: "tools", label: "WORKFLOW & TOOLS", icon: Globe2,
    skills: [
      { name: "Git / GitHub", lvl: 86, notes: "Managed project versions, repositories, and portfolio source code.", related: ["Commits", "README"] },
      { name: "pytest", lvl: 74, notes: "Wrote tests for ingestion and pipeline utility logic.", related: ["Unit Tests", "Validation"] },
      { name: "YAML Config", lvl: 72, notes: "Used configuration files to control pipeline behavior and environments.", related: ["Config", "Environment"] },
      { name: "Linux / Bash", lvl: 72, notes: "Used command-line workflows for development, scripts, and local services.", related: ["Shell", "CLI"] },
      { name: "VS Code", lvl: 86, notes: "Main development environment for Python, React, and data projects.", related: ["Extensions", "Debugging"] },
    ],
  },
] as const;
